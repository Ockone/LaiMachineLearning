...
y = sin(angle);             % 纵坐标
W = [x', y'];               % 组成权值矩阵
W = W * 100 + [mean(city(:,1)),mean(city(:,2))];             % 让该圆环起始位置足够小
