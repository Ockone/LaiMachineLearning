...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      options = [];
      options.k = 5;            % 2到{min(Nc) - 1}之间，即应小于最小类别的样本数
      options.NeighborMode = 'Supervised';
      options.gnd = train_label;
      options.ReducedDim = 160; % 降维的目标维数，默认是30
      [eigvector, ~] = NPE(options, train_data');
      U = eigvector;    % 这个参数设置只能得到137维投影向量
...
xlabel("维数");
ylabel("准确率");
%acc = predict(train_data, test_data, U, 3);
